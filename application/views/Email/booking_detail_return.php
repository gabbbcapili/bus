    ...
    <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px;font-weight:600; "> BOOKING DETAILS </div>
        ...
        <div style="background:#f4f4f4;  float:left; width:96.3%;   border-top-right-radius: 8px; border-top-left-radius: 8px; padding:15px 12px 0 12px;  ">
    		<div style="width:100%; padding:10px 0 10px 0; float:left; color:#666261; font-size:14px;"> Hi <?php echo $data[0]['username'];?>, thanks for booking with us. </div>
                 ...
                 <div style="width:70%; float:left; font-size:17px;"> <?php echo $data[1]['booking_id'];?> </div>
                 <div style="width:30%; float:left;"> 
                 
                 <a href="#"> <div style="color:black; 
                 text-align:center; line-height:25px; text-decoration:none; float:right;">Status:<?php echo $data[1]['payment_status'];?>  </div> </a>
        ...
        <div style="background:#3a3a3c;     float:left; width:96.3%;  padding:0px 12px 10px 12px;">
            ...
            <div style="width:43%; float:left; color:white; font-size:15px; padding:5px 0 0 0; line-height:22px;"> <?php echo $data[1]['board_point'];?>
				
				
			
				</div>
            <div style="width:33.3% ;float:left; text-align:center;"> <img src="<?php echo base_url();?>assets/images/arrowround.png" alt="" /> </div>
            <div style="width:33.3%; float:left; color:white; font-size:16px; padding:5px 0 0 0; line-height:22px;"> <?php echo $data[1]['drop_point'];?></div>
            </div>
            ...
            <div style="width:100%; float:left;">
                ...
                <div style="width:100%; float:left; text-align:center; color:#bbbbbb; font-size:14px; padding:5px 0 0 0;"> <?php echo $data[1]['bus_name'];?></div> 
                </div>
                ...
                <div style="width:32%;   float:left; background:#585858; padding:24px 0 24px 0; "> 
                <div style="width:100%; float:left; text-align:center; color:#fff; font-size:15px;"> <?php echo $data[1]['board_time'];?> . </div>
                <div style="width:100%; float:left; text-align:center; color:#bbbbbb; font-size:14px; padding:5px 0 0 0;"> <?php echo date('D, d M',strtotime($data[1]['booking_date']));?></div> 
                </div>
            </div>
           <br>
